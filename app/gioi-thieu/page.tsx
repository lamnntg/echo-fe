...
export default function Introduce() {
  return (
    <main className="container mx-auto py-20 bg-white text-[#333] font-medium px-3">
      <div className="flex items-end gap-12 flex-col lg:flex-row">
        <div className="flex-1 animate-leftToRight">
          <h2 className="text-[28px] mb-6 text-left lg:text-right">
            WELCOME TO ECHO DESIGN!
          </h2>
          <p className="text-left lg:text-right font-thin text-[15px]">
          ...
          <p className="text-left lg:text-right font-thin mt-3 text-[15px]">
