...
const Card: FC<CardProps> = ({ project }) => {
  ...
  return (
    ...
    >
      ...
      <div className="py-2 px-6 absolute transition-all duration-300 group-hover:top-0 top-[calc(100%-44px)] left-0 w-full h-full backdrop-blur-[3px] bg-[hsla(0,0%,100%,.7)]">
